...
const AddRoom = () => {
  ...
  return (
    <form className='mt-8'>
      <Title align='left' font='outfit' title='Add Room' subTitle='Fill 
      in the details carefully and accurate room details, pricing, and amenities, ,to
      ...
      <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
        ...
        <div>
          ...
          rounded p-2 w-24' value={inputs.pricePerNight} onChange={e=> 
          ...
          <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm'>
            {Object.keys(inputs.amenities).map((amenity, index)=> (
              <div key={index} >
                ...
                checked={inputs.amenities[amenity]} onChange={()=>setInputs({...inputs, amenities: 
                  {...inputs.amenities, [amenity]: !inputs.amenities[amenity]}
                })} />
                <lebel htmlFor={`amenities${index+1}`}>{amenity}</lebel>
              </div>
            ))}
          </div>
