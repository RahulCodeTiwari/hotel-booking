...
const AllRooms = () => {
    ...
    const isRoomTypeSelected = (roomType) => {
        return selectedFilters.roomType.length === 0 || selectedFilters.roomType.includes(roomType);
    }
    ...
    // Filter and sort rooms based on the seleceted filters and sort option
            ...
            overFlow-hidden transition-all duration-700`}>
                <div className='px-5 pt-5'>
                    ...
                    {roomTypes.map((room, index)=> (
                        ...
                        roomType.includes(room)} onChange={(checked)=> handleFilterChange
