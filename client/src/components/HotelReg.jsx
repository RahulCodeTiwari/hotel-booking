...
const HotelReg = () => {
  ...
  return (
    ...
    className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-cetner justify-center
    bg-black/70'>
            ...
            <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                ...
                {/* phone */}
                 <div className='w-full mt-4'>
                    ...
                    <input id='contact' onChange={(e)=> setContact(e.target.value)} value={contact} type="text" placeholder="Type Here" className='border border-gray-200
                    rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required/>
                </div>
                ...
                <div className='w-full mt-4 max-w-60 mr-auto'>
                    ...
                    <select id="city" onChange={(e)=> setCity(e.target.value)} value={city} className='className="border border-gray-200 rounded
